...
namespace DM.Log.Dal
{
    ...
    //public class BaseDBContext1 : DbContext //, IUnitOfWork
    //{
    ...
    //    public BaseDBContext1(DbType dbType = DbType.Oracle) : this(null, dbType) { }
    ...
    //    /// </summary>
    //    public BaseDBContext1(DbContextOptions options) : base(options)
    //    {
    ...
    //    public BaseDBContext1(string conStr, DbType dbType = DbType.Oracle)
    //    {
